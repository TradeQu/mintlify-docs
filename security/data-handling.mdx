...
Decision contexts (`fields`, `metadata`, `evidence`) are sent by your application. You control what data is included. Avoid sending sensitive personally identifiable information unless required by your policies. Use opaque identifiers (account IDs, order IDs) rather than raw personal data where possible.
...
If you discover a security vulnerability, contact security@meshqu.io. Do not disclose publicly until a fix is available.
