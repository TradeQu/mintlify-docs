...
See the [Receipt Reference](concepts/receipt-reference) for the field-level contract, and [Verifying Offline](guides/verifying-offline) to check one yourself.
