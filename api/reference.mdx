...
```json
{
  ...
  "warnings": [],
  "sequence": [
    { "step": 1, "decision_id": "aaa-...", "decision": "REVIEW", "integrity_verified": true },
    { "step": 2, "decision_id": "bbb-...", "decision": "ALLOW", "integrity_verified": true },
    { "step": 3, "decision_id": "ccc-...", "decision": "ALLOW", "integrity_verified": true }
  ],
...
<Note>
Phase 1 chain verification proves each individual receipt is cryptographically sound. Chain structure (grouping, ordering) relies on database constraints and immutability triggers. Cryptographic proof of the chain as a unit is planned for Phase 2.
</Note>
