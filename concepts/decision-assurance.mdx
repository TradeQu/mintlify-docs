...
| **L4** Bundled | Self-contained, offline-verifiable archive — receipt + policy snapshot + chain proofs + transparency proof + trust roots — under a digest-of-digests manifest. **10 sub-claims.** | Implemented |
