...
- **Prefix/suffix** — a safe fragment (e.g. `mqu_...ai4`) shown in dashboards for identification.

<Note>
  Keys are `mqu_` followed by a base64url-encoded random token (e.g.
  `mqu_tYrzhhHfchPhHvffuQAF5z0JpJK9pWw__3L1Qk_-ai4`). There is no
...
```json
{
  ...
  "plaintext_key": "mqu_tYrzhhHfchPhHvffuQAF5z0JpJK9pWw__3L1Qk_-ai4"
}
```
